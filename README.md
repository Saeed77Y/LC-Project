...
in the last sixteen minutes (up to two hexadecimal digits) and show them to the user; the user can choose
...
### Data saver:
![Data saver](https://github.com/ُSaeed77Y/LC-Project/blob/main/pics/3.png)
